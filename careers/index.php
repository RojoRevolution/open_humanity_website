<?php 
$pageTitle = "Careers at Open Humanity";
$bodyID = "careers";
require('../includes/head.php') 
?>
    <?php require('../includes/mobile-menu.php') ?>
    <?php require('../includes/main-header.php') ?>
    <section id="career-content" class="container-flex py-5">
        <div class="container py-5">
            <h1>Careers</h1>
            <p>There are currently no open positions at Open Humanity. But check back soon.</p>
        </div>
    </section>
